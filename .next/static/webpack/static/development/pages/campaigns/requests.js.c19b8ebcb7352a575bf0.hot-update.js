  ...
  _createClass(Request, [{
    ...
    value: function renderrow() {
      ...
      return this.props.requests.map(function (request, index) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_requestrow__WEBPACK_IMPORTED_MODULE_7__["default"], {
          request: request,
          key: index,
          id: index,
          approval: _this.props.approver_count,
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(props) {
        var camp, approver_count, tot_req, requests;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                camp = _context.sent;
                _context.next = 5;
                return camp.methods.total_contribution().call();

              case 5:
                approver_count = _context.sent;
                _context.next = 8;
...
//# sourceMappingURL=requests.js.c19b8ebcb7352a575bf0.hot-update.js.map