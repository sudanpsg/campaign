...
function (_Component) {
  ...
  _createClass(Mycampaign, [{
    ...
    value: function rendercamp() {
      ...
      console.log("hi world", this.props.camps);
      var items = this.props.campaigns.map(function (address) {
        return {
          ...
          description: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
            ...
            __self: this
          }, "Minimum contribution ", _this2.props.vals),
          fluid: true
        };
      });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                i = 0; //const camp = new web3.eth.Contract(
                    ...
                    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            console.log("each address is ", address);
                            _context.next = 3;
                            return new _ether_web3__WEBPACK_IMPORTED_MODULE_6__["default"].eth.Contract(JSON.parse(_ether_build_campaign_json__WEBPACK_IMPORTED_MODULE_5__.interface), address);

                          case 3:
                            camparr = _context.sent;
                            console.log("insed the sync address is", camparr[i]);
                            val = camparr[i].methods.minamnt().call();
                ...
                console.log("my camps is ", camparr); // const vals = await camps[0].methods.minamnt().call();
...
//# sourceMappingURL=index.js.89ac62859f761701d524.hot-update.js.map